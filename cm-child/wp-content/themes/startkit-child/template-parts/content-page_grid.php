					...
					<?php if( $loop->have_posts() ): ?>
                        ...
                        <div class="post-content">
							...
							<?php 
								...
								// 	) 
								// );
								// niet meer de volledige tekst maar slechts een deeltje
								the_excerpt();
							?>
							<!-- de auteur staat onderaan-->
							<?php esc_html_e('By','startkit'); ?> <a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) ));?>"><?php esc_html(the_author()); ?></a>
                        </div>
